...
class Control
{
        ...
        std::vector<double> Dn_, Jn_, gn_, Kp_, Kd_, Kf_, Fc_, k_, Fv_, Fo_;

        bool Setup(void);
        void Setstate(int state);
        void Shutdown(void);

        void SetParameter(const std::vector<double>& Dn,
